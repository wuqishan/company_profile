<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/courses/styles/main_styles.css'); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/courses/styles/responsive.css'); ?>">
    ...
    <div class="menu_inner menu_mm">
        <div class="menu menu_mm">
            <ul class="menu_list menu_mm">
                <li class="menu_item menu_mm"><a href="<?=site_url('courses')?>">Home</a></li>
                <li class="menu_item menu_mm"><a href="<?=site_url('courses/course')?>">Courses</a></li>
        ...
        <div class="hero_slider owl-carousel">
            ...
            <div class="hero_slide">
                <div class="hero_slide_background"
                     style="background-image:url(<?php echo base_url('public/courses/images/slider_background.jpg'); ?>)"></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 hero_box_col">
                    <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                        <img src="<?php echo base_url('public/courses/images/earth-globe.svg'); ?>" class="svg" alt="">
                ...
                <div class="col-lg-4 hero_box_col">
                    <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                        <img src="<?php echo base_url('public/courses/images/books.svg'); ?>" class="svg" alt="">
                        <div class="hero_box_content">
                ...
                <div class="col-lg-4 hero_box_col">
                    <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                        <img src="<?php echo base_url('public/courses/images/professor.svg'); ?>" class="svg" alt="">
                        <div class="hero_box_content">
    ...
    <div class="container">
        ...
        <div class="row course_boxes">
            ...
            <div class="col-lg-4 course_box">
                <div class="card">
                    <img class="card-img-top" src="<?php echo base_url('public/courses/images/course_1.jpg'); ?>"
                    ...
                    <div class="price_box d-flex flex-row align-items-center">
                        <div class="course_author_image">
                            <img src="<?php echo base_url('public/courses/images/author.jpg'); ?>"
            ...
            <div class="col-lg-4 course_box">
                <div class="card">
                    <img class="card-img-top" src="<?php echo base_url('public/courses/images/course_2.jpg'); ?>"
            ...
            <div class="col-lg-4 course_box">
                <div class="card">
                    <img class="card-img-top" src="<?php echo base_url('public/courses/images/course_3.jpg'); ?>"
            ...
            <div class="col-lg-6 nopadding">
                ...
                <div class="search_section d-flex flex-column align-items-center justify-content-center">
                    <div class="search_background"
                         style="background-image:url(<?php echo base_url('public/courses/images/search_background.jpg'); ?>);"></div>
        ...
        <div class="row services_row">
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/earth-globe.svg'); ?>" alt="">
                </div>
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/exam.svg'); ?>" alt="">
                </div>
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/books.svg'); ?>" alt="">
                </div>
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/professor.svg'); ?>" alt="">
                </div>
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/blackboard.svg'); ?>" alt="">
                </div>
                <h3>Top Programs</h3>
                <p>In aliquam, augue a gravida rutrum, ante nisl fermentum nulla, vitae tempor nisl ligula vel nunc.
                    Proin quis mi malesuada, finibus tortor fermentum.</p>
            ...
            <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                <div class="icon_container d-flex flex-column justify-content-end">
                    <img src="<?php echo base_url('public/courses/images/mortarboard.svg'); ?>" alt="">
                </div>
...
<div class="testimonials page_section">
    ...
    <div class="testimonials_background_container prlx_parent">
        <div class="testimonials_background prlx"
             style="background-image:url(<?php echo base_url('public/courses/images/testimonials_background.jpg'); ?>)"></div>
    </div>
    <div class="container">
                            ...
                            <div class="testimonials_item text-center">
                                ...
                                <div class="testimonial_user">
                                    <div class="testimonial_image mx-auto">
                                        <img src="<?php echo base_url('public/courses/images/testimonials_user.jpg'); ?>"
                                             alt="">
                                    </div>
                    ...
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="<?php echo base_url('public/courses/images/event_1.jpg'); ?>" alt="">
                            </div>
                        </div>
            ...
            <div class="row event_item">
                <div class="col">
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="<?php echo base_url('public/courses/images/event_2.jpg'); ?>" alt="">
                            </div>
                        </div>
            ...
            <div class="row event_item">
                <div class="col">
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="<?php echo base_url('public/courses/images/event_3.jpg'); ?>" alt="">
                            </div>
                        </div>
